                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 sticky top-6">
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex justify-between text-sm">
                      <span className="text-[#737373] md:text-base text-[10px] font-medium">
                        Subtotal
                      </span>
                    ...
                    <div className="flex justify-between">
                      <span className="text-[#737373] text-[10px] md:text-sm font-medium">
                        Discount
                      </span>
                      <span className="text-xs md:text-base font-semibold text-[#081021]">
                        £{discount.toFixed(2)}
                    ...
                    <div className="border-t pt-4">
                      <div className="flex justify-between text-lg font-semibold">
                        ...
                        <span className="text-xs md:text-lg font-semibold text-[#081021]">
                          £{total.toFixed(2)}
                        </span>
                      </div>
                    </div>
